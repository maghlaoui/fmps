...
class InscriptionController extends Controller {
    ...
    public function newAction() {
        ...
        $paiement = new \Acme\FmpsBundle\Entity\Paiement;
        $paiement_form = $this->createForm(new PaiementType(), $paiement);
        ...
        return array(
            ...
            'paiement_form' => $paiement_form->createView()
        );
    }
...
//    }
     ...
     * Creates a new Inscription entity.
     *
     * @Route("/create", name="inscription_create_all")
     * @Method("post")
     * @Template("AcmeFmpsBundle:Inscription:new.html.twig")
     */
    public function createallAction() {
        ...
        $titeur_form = $this->createForm(new TiteurType(), $entityTiteur);
        ...
        if ($titeur_form->isValid() && $enfant_form->isValid() && $inscription_form->isValid()) {
            $em = $this->getDoctrine()->getEntityManager();
