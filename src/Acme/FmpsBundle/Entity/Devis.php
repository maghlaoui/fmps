...
/**
 * Acme\FmpsBundle\Entity\Devis
 *
 * @ORM\Table(name="devis")
 * @ORM\Entity(repositoryClass="Acme\FmpsBundle\Entity\DevisRepository")
...
class Devis
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="BonCommande", inversedBy="devis")
    ...
    public function preUpload()
    {
        if (null !== $this->fichier) {
            $this->path = 'devis_'.uniqid().'.'.$this->fichier->guessExtension();
        }
    }
