...
/**
 * Acme\FmpsBundle\Entity\Decharge
 *
 * @ORM\Table(name="ecole_decharge")
 * @ORM\Entity(repositoryClass="Acme\FmpsBundle\Entity\DechargeRepository")
...
class Decharge
{
     ...
     * @var text $cin
     *
     * @ORM\Column(name="cin", type="text", nullable=false)
     */
    private $cin;
    ...
    /**
     * @var string $natureDepense
     *
     * @ORM\Column(name="nature_depense", type="string", length=125, nullable=false)
     */
     ...
     * Set natureDepense
     *
     * @param string $natureDepense
     */
    public function setNatureDepense($natureDepense)
    {
    ...
    public function preUpload()
    {
        if (null !== $this->fichier) {
            $this->path = 'decharges_'.uniqid().'.'.$this->fichier->guessExtension();
        }
    }
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Ecole", inversedBy="decharges", cascade={"persist"})
